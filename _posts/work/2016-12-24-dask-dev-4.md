...
<a href="{{ BASE_PATH }}/images/bad-work-stealing.png">
    <img src="{{ BASE_PATH }}/images/bad-worker-stealing.png"
...
on these workloads.  On other workloads we're able to get inter-task lag down
to the tens of microseconds scale.  While 10ms may not sound like a long time,
when we perform very many very short tasks this can quickly become a
bottleneck.
