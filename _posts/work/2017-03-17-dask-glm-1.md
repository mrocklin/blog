...
machines (or just on our laptop).
...
From a parallel computing perpsective this is a pretty simple map-reduce procedure.  Any distributed computing framework should be able to handle this easily.  We'll use this as a very simple example for how to use Dask's more customizable parallel options.
...
larger-than-memory by operating off of disk on a single computer or on a
...
on this project.  We hope that some of the issue above provide seeds for
