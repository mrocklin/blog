...
The ADMM computation actually produced a poor result here, with an $L_{\infty}$ norm of
`0.64`; we're working to figure out why.  Proximal gradient produced an error
that is more in line with previous computations of `0.029`.
