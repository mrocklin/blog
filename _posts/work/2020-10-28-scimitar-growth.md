...
around a pre-existing community OSS project that I help to maintain,
[Dask](https://dask.org),
...
-   **SF:** *I want to make an open source project in order to quickly drive adoption of my
    product.  How did you get traction with the open source community?*

    **Me:** *Six years of listening and diligently solving community problems*

This timeline doesn't make sense for really any for-profit company.

He went on to ask about rapid, hockey-stick growth.

-   **SF:** *Well when did you finally achieve hockey-stick growth?*

    **Me:** *Never.*

    *Dask grew organically.  See my post on [Estimating Users](https://blog.dask.org/2020/01/14/estimating-users) and this image of weekly unique IPs to API documentation (my preferred metric)*
...
In another conversation a VC investor asked me about the GitHub stars for Dask.
...
-   **VC:** *I guess that's ok*
    ...
    **Me:** *But a better matric is probably that 5% of Python users use Dask
    ...
    Dask is by far the most popular native Python framework ever made.

-   **VC:** *Oh.*

<img src="https://mk0coiled27knr0w73eb.kinstacdn.com/wp-content/uploads/dask-users-psf-survey-white-on-black.png" width="60%">
...
number is for *all* Python users, include web developers, and people who never
touch big data).  The thing to think about now is *company* adoption.  Just
because some data scientist is using Dask inside of every Fortune 50 company
doesn't mean that those companies use Dask throughout.  That metric is harder
though.
...
Dask supports.  As a *community* project, Dask tries really hard to blend in
