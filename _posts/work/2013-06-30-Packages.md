...
Which is illustrated with the following pair of images (left: siloed code, right: open code)
...
<img src="{{ BASE_PATH }}/images/care.png" width="50%"> 
<img src="{{ BASE_PATH }}/images/care2.png" width="50%"> 
