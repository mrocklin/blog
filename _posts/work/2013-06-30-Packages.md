...
*I originally presented this idea as a lightning talk at SciPy-2013.  It recieved considerable attention*
...
|:--------------------------------------------------------:|:---------------------------------------------------------:|
| General and specific code linked                         | Specific code calls general code                          | 
...
Developing new code with uncertain and dynamic interfaces is challenging.  This challenge is compounded by the constant juggling of repository state.  Cross developing different functions in many repostitories imposes a significant mental load.
...
Placing source code and test code into separate projects specifies a clear interface and enables open competition. 
